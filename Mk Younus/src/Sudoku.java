...
// the 9 x 9 grid   
		int[][] b = new int[][] { { 0, 0, 8, 0, 4, 0, 0, 0, 1 }, { 7, 0, 0, 0, 6, 3, 4, 0, 8 },
				{ 0, 0, 0, 5, 0, 0, 0, 2, 0 }, { 0, 0, 0, 0, 0, 0, 0, 3, 5 }, { 0, 0, 1, 0, 0, 0, 9, 0, 0 },
				{ 2, 9, 0, 0, 0, 0, 0, 0, 0 }, { 0, 8, 0, 0, 0, 2, 0, 0, 0 }, { 1, 0, 4, 6, 3, 0, 0, 0, 7 },
				{ 6, 0, 0, 0, 8, 0, 5, 0, 0 } };
