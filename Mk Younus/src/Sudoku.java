...
// the 9 x 9 grid   
		int[][] b = new int[][] { { 0, 4, 8, 0, 0, 9, 6, 0, 0 }, { 0, 2, 0, 0, 6, 0, 1, 0, 0 },
				{ 0, 0, 3, 2, 0, 0, 0, 0, 7 }, { 4, 0, 0, 0, 0, 0, 0, 6, 0 }, { 0, 5, 0, 9, 0, 4, 0, 1, 0 },
				{ 0, 8, 0, 0, 0, 0, 0, 0, 4 }, { 1, 0, 0, 0, 0, 8, 4, 0, 0 }, { 0, 0, 7, 0, 1, 0, 0, 2, 0 },
				{ 0, 0, 4, 3, 0, 0, 8, 7, 0 } };
